# Generated by Django 2.2.16 on 2022-02-24 18:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(1500), django.core.validators.MaxValueValidator(2022)], verbose_name='Дата выхода произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='reviews.Title', verbose_name='Отзыв по произведению')),
            ],
            options={
                'verbose_name': 'Отзыв',
